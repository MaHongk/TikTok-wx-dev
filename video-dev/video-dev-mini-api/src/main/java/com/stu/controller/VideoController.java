...
public class VideoController extends BasicController {
    ...
    public IMoocJSONResult uploadFace(String userId,
        ...
        //文件保存的命名空间
//        String fileSpace = "F:/stu_videos_dev";
        //保存到数据库中的相对路径
        ...
        //判断bgmId是否为空，如果不为空，查询bgm信息，并合并视频产生新的视频
        ...
        video.setVideoSeconds(Float.parseFloat(videoSeconds.toString()));
