...
import com.stu.cofig.ResourceConfig;
...
public class ZKCuratorClient {
    ...
    //    public static final String ZOOKEEPER_SERVER = "192.168.";
    @Autowired
    ...
    public void init() {
        ...
        client.start();
        try {
//           String testNodeDate=new String( client.getData().forPath("/bgm"));
//           log.info("测试的节点数据为:{}",testNodeDate);
            addChildWatch("/bgm");
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                    String songPath = bgm.getPath();
                    //2.定义保存到本地bgm路径
//                    String filePath = "F:\\stu_video_dev" + songPath;
...
//                    String bgmUrl = "http://192.168/mvc" + filePath;
