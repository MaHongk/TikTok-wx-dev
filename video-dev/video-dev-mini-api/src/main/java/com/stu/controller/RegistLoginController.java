...
import com.stu.pojo.vo.UsersVO;
...
public class RegistLoginController extends BasicController{
   ...
   /*     String uniqueToken= UUID.randomUUID().toString();
        ...
        UsersVO userVO = setUserRedissSessionToken(user);
        return IMoocJSONResult.ok(userVO);
    }

    public UsersVO setUserRedissSessionToken(Users userModel){
        String uniqueToken= UUID.randomUUID().toString();
    ...
    public IMoocJSONResult login(@RequestBody Users user) throws Exception {
        ...
        if (userResult != null) {
            ...
            UsersVO userVO = setUserRedissSessionToken(userResult);
            return IMoocJSONResult.ok(userVO);
        } else {
