...
<%--<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.2.30:8081"/>--%>
<%--<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.2.30:8080/mvc"/>--%>
 <input type="hidden" id="apiServer" name="apiServer" value="http://49.235.221.56/v"/>
 <input type="hidden" id="bgmServer" name="bgmServer" value="http://139.196.95.227/mvc"/>
